...
print('My name is Debora'.split())
print('My name is Debora'.split('m'))
print('My,name,is,Debora'.split(','))
...
print('SpamSpamBaconSpamEggsSpamSpam'.strip('ampS')) #order doesnt matter

#replace()
print('Hello There! Hey You!'.replace('H', 'h'))
